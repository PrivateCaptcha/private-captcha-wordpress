...
= 1.0.42 =
* Fix additional fields sync in WooCommerce

= 1.0.41 =
* Fix edge cases of CF7 integration
* Fix next button for Forminator

= 1.0.40 =
* Fix captcha reset for Elementor

= 1.0.39 =
* Bugfixes

= 1.0.38 =
* Fix conflict between Woo registration during checkout

= 1.0.37 =
* Improvements for WooCommerce blocks checkout

= 1.0.36 =
* Reset captcha on block checkout errors

= 1.0.35 =
* Improve WooCommerce block checkout
...
= 1.0.28 =
* Fix WooCommerce checkout integration

= 1.0.27 =
* Stability improvements

= 1.0.26 =
* More WooCommerce bugfixes
...
= 1.0.21 =
* Add detailed error message and update languages
...
= 1.0.13 =
* Fix testing credentials under tighter security

= 1.0.12 =
* Improve Private Captcha API use for improved verification security

= 1.0.11 =
* Add 'auto' language support for widget

= 1.0.10 =
* Add form pre-validation support for Contact Form 7 integration
